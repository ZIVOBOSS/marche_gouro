                                    ...
                                    <div class="collapse navbar-collapse">
                                        <ul class="navigation">
                                            ...
                                            <li class="dropdown"><a href="#">Apropos</a>
                                                <ul>
                                                    <li><a href="about.html">Historiaue</a></li>
                                                    <li><a href="faq.html">Cooperative</a></li>
                                                    <li><a href="team.html">Marché</a></li>
                                                    <li class="dropdown"><a href="#">Cqtqlogue</a>
                                                        <!--  <ul>
                                            ...
                                            <li class="dropdown"><a href="#">Centre commercial</a>
                                                <ul>
