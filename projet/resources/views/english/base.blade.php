...
<head>
<meta charset="utf-8">
<title>GOURO HTML Template</title>
                    ...
                    <div class="left-content">
                        <div class="language-switcher">
                            <div class="languages">
                                ...
                                <ul>
                                <li><a href="/en/pre">Francais</a></li>
                                    <li><a href="/en/pre">English</a></li>
                            
                                </ul>
                            </div>
                        </div>
                        <div class="text">Vous nourrir ,c'est notre priorité.. <a href="#" class="donate-box-btn">Nous ecrire.</a></div>
                    </div>
                    <div class="right-content">
                        <ul class="contact-info">
                            <li><span class="flaticon-mail"></span><a href="mailto:support@marché.com">support@charity.com</a></li>
                            <li><span class="flaticon-phone"></span><a href="tel:+211456789">+225 456 789</a></li>
                        </ul>
            ...
            <div class="auto-container">
                <div class="wrapper-box">
                    <div class="logo-column">
                        <div class="logo-box">
                            <!-- <div class="logo"><a href="/en/pre"><img src="images/logo.png" alt="" title=""></a></div> -->
                             <div class="logo"><a href="/en/pre">logo</a></div> 
                        </div>
                    </div>
                        ...
                        <div class="option-wrapper">
                            ...
                            <nav class="main-menu navbar-expand-xl navbar-dark">
                                    ...
                                    <div class="collapse navbar-collapse">
                                        <ul class="navigation">
                                            <li class="dropdown current"><a href="index-2.html">Accueil</a>
                                                <ul>
                                            ...
                                            <li class="dropdown"><a href="#">Apropos</a>
                                                <ul>
                                                    <li><a href="/en/pre">Historiaue</a></li>
                                                    <li><a href="/en/pre">Cooperative</a></li>
                                                    <li><a href="/en/pre">Marché</a></li>
                                                    <li class="dropdown"><a href="#">Catalogue</a>
                                                        <!--  <ul>
                                                    ...
                                                    <li class="dropdown"><a href="#">Services</a>
                                                        <ul>
                                                            <li><a href="/en/pre">Nos produits</a></li>
                                                            <li><a href="/en/pre"></a>Articles</li>
                                            ...
                                            <li class="dropdown"><a href="/en/pre">Centre Commercial</a>
                                                <!-- <ul>
                                            ...
                                            <li class="dropdown"><a href="/en/pre">Nos Activités</a>
                                                <ul>
                                                   <!--  <li><a href="events-1.html">Events</a></li>-->
                                                    <li><a href="/en/pre">Single Event</a></li>
                                                </ul>
                                            </li>
            ...
            <div class="content">
                ...
                <div class="news-widget-two sidebar-widget">
                    ...
                    <div class="post-wrapper">
                        ...
                        <h4><a href="blog-details.html">GOURO partners with lafarge on national literacy competition</a></h4>
                    </div>
                    <div class="post-wrapper">
                        ...
                        <h4><a href="blog-details.html">GOURO improves education infrastructure</a></h4>
                    </div>
                </div>
                <!-- Newsletter Widget -->
                    ...
                    <div class="content-outer">
                        <div class="content-box justify-content-center">
                            <div class="inner text-center">
                                <h4><span class="border-shape-left"></span> VOTRE MARCHÉE DE SIPOREX <span class="border-shape-right"></span></h4>
                                
                                <h1>Projet de Centre commercial </h1>
                    ...
                    <div class="content-outer">
                        <div class="content-box justify-content-center">
                            <div class="inner text-center">
                                ...
                                <h3>Notre Cooperative compte 16666 Membres </h3>
                                <h1>Together we can make <br>a Difference</h1>
                                <div class="link-box"><a href="#" class="theme-btn btn-style-one donate-box-btn"><span>Devenir Membre?</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content-block">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="link-btn wow fadeInLeft" data-wow-delay="500ms"><a href="#" class="theme-btn btn-style-two"><i class="flaticon-next"></i><span>Notre Mission</span></a></div>
                                <div class="text">Beguiled and demoralized by the charms off pleasure the moments, so by desire trouble.</div>
                            </div>
                            <div class="col-md-6">
                                <div class="link-btn wow fadeInRight" data-wow-delay="900ms"><a href="#" class="theme-btn btn-style-three"><i class="flaticon-next"></i><span>Notre Vision</span></a></div>
                        ...
                        <div class="link-btn-two">
                            <a href="#" class="theme-btn btn-style-one"><span>Voir plus </span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <!-- <div class="event-tabs-content"> -->
                        ...
                        <div class="event-tab active-tab" id="event-tab-1">
                            <div class="event-carousel owl-theme owl-carousel owl-dot-style-one owl-nav-none">
                                ...
                                <!-- Event Blokc One --                                <div class="event-block-one">
                                    <div class="inner-box">
                                        <div class="image"><img src="images/resource/event-1.jpg" alt=""></div>
                                        <div class="lower-content">
                                            <div class="date">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 news-block-one">
                    <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="image">
                            <a href="blog-details.html"><img src="images/resource/news-1.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-md-6 news-block-one">
                    <div class="inner-box wow fadeInDown" data-wow-delay="400ms">
                        ...
                        <div class="image">
                            <a href="blog-details.html"><img src="images/resource/news-2.jpg" alt=""></a>
                            <div class="post-meta-info">
                ...
                <div class="col-lg-3 col-md-6 news-block-one">
                    <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="image">
                            <a href="blog-details.html"><img src="images/resource/news-3.jpg" alt=""></a>
                            <div class="post-meta-info">
                ...
                <div class="col-lg-3 col-md-6 news-block-one">
                    <div class="inner-box wow fadeInDown" data-wow-delay="400ms">
                        ...
                        <div class="image">
                            <a href="blog-details.html"><img src="images/resource/news-4.jpg" alt=""></a>
                            <div class="post-meta-info">
        ...
        <div class="auto-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 contact-widget footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="mailto:support@GOURO.com">supportyou@GOURO.com </a></li>
                        </ul>   
            ...
            <div class="footer-bottom">
                <div class="left-content">
                    ...
                    <div class="icon text-white">LOGO</div>
                    <div class="copyright-text"><a href="google">PLANIUM</a><a href="#">GOURO.</a> <br>Designed By <a href="#">UNIKPLATNIUM</a></div>
                </div>
                <div class="right-content">
