...
<div class="page-wrapper">
    ...
    <header class="main-header">
                ...
                <div class="wrapper-box">
                    ...
                    <div class="right-content">
                        <ul class="contact-info">
                            <li><span class="flaticon-mail"></span><a href="mailto:support@marche.com">support@marchee.com</a></li>
                            ...
                            <div class="nav-outer">
                                ...
                                <nav class="main-menu navbar-expand-xl navbar-dark">
                                    ...
                                    <div class="collapse navbar-collapse">
                                        <ul class="navigation">
                                            <li class="dropdown current"><a href="/en">Accueil</a>
                                                <ul>
                                                    <li><a href="   "> Home</a></li>
                                            ...
                                            <li class="dropdown"><a href="/en/pre">Apropos</a>
                                                <ul>
                                                <li><a href="/en/mot_du_president">Mot du president</a></li>
                                                    <li><a href="/en/historique">Historique</a></li>
                                                    <li><a href="/en/cooperative">Cooperative</a></li>
                                                    <li><a href="/en/marche">Marché</a></li>
                                               ...
                                               <!--<li class="dropdown"><a href="/en/centre_comercial">Centre Commercial</a>
                                              <ul>
                                             ...
                                             <!-- <li class="dropdown"><a href="/en/services">Nos Services</a>
                                               <ul>
                                                   <!--  <li><a href="events-1.html">Events</a></li>
                                                    <li><a href="/en/pre">Vente en Gros</a></li>
                                                    <li><a href="/en/pre"></a>Fournisseur Agricole</li>
                                                </ul> 
                                            </li>-->
                                           <!--  <li class="dropdown"><a href="/en/pre">Nos Activités</a>
                                            ...
                                            <li><a href="/en/centre_comercial">Centre Commercial</a></li>

                                            <li><a href="/en/activite">Nos Activités</a></li>
        ...
        <div class="mobile-menu style-one">
            <div class="menu-box">
                <div class="logo"><a href="/en/pre"><img src="images/logo.png" alt=""></a></div>
                <!-- Main Menu -->
                <nav class="main-menu navbar-expand-xl navbar-dark">
