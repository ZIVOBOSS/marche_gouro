...
@include('english/header/header')
    ...
    <section class="upcoming-events-section-two style-two" style="background-image: url(/images/background/bg-15.jpg);">
        <div class="auto-container">
            <div class="sec-title text-center light">
                <h1>Projet - de developement  <br>Social</h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="content">
                                    ...
                                    <div class="info-box">
                                        <h5>Email</h5>
                                        <a href="mailto:reuben@gouro.com">reuben@goodsoul.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="content">
                                    ...
                                    <div class="info-box">
                                        <h5>Phone</h5>
                                        <a href="tel:+225 4567890">+211 456 7890</a>
                                    </div>
                                    <div class="info-box">
                                        <h5>Email</h5>
                                        <a href="mailto:reuben@gouro.com">reuben@goodsoul.com</a>
    ...
    <section class="team-section-four">
        <div class="auto-container">
            <div class="sec-title">
                <h1>Les Partenaires Associés a l'evenement</h1>
